window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ths_module_css_default = {
			"aionPreviewIn": "tWPVfW_aionPreviewIn",
			"thsStatusbar": "tWPVfW_thsStatusbar",
			"thsStatusbarCell": "tWPVfW_thsStatusbarCell",
			"thsStatusbarSpacer": "tWPVfW_thsStatusbarSpacer",
			"thsTitlebar": "tWPVfW_thsTitlebar",
			"thsTitlebarBtn": "tWPVfW_thsTitlebarBtn",
			"thsTitlebarIcon": "tWPVfW_thsTitlebarIcon",
			"thsTitlebarTicker": "tWPVfW_thsTitlebarTicker",
			"thsTitlebarTickerChg": "tWPVfW_thsTitlebarTickerChg",
			"thsTitlebarTickerVal": "tWPVfW_thsTitlebarTickerVal",
			"thsTitlebarTitle": "tWPVfW_thsTitlebarTitle"
		};
		//#endregion
