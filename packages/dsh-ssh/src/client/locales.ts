...
export const zh = {
  ...
  'monitor.selectHost': '选择监控主机',
  'monitor.noHosts': '请先在「主机」页添加 SSH 主机。',
  'monitor.live': '实时刷新',
  'monitor.interval': '每 3 秒',
  'monitor.refreshing': '正在采集…',
  'monitor.openTerminal': '打开终端',
  'monitor.unsupported': '暂不支持 {platform} 主机的指标采集；可以继续使用实时终端。',
  'monitor.cpu': 'CPU',
  'monitor.memory': '内存',
  'monitor.disk': '系统盘',
  'monitor.load': '负载 1 / 5 / 15m',
  'monitor.uptime': '运行时间',
  'monitor.processCount': '进程数',
  'monitor.topProcesses': 'CPU 占用最高的进程',
  'monitor.command': '进程',
  'monitor.terminate': '终止',
  'monitor.killConfirm': '确定向 PID {pid}（{command}）发送 TERM 信号吗？这会真实影响远程服务。',
  'monitor.failedServices': '失败的 systemd 服务',
  'monitor.servicesHealthy': '没有检测到失败服务。',
  'monitor.restart': '重启',
  'monitor.restartConfirm': '确定通过 sudo 重启远程服务「{service}」吗？',
  'monitor.actionDone': '远程操作已完成。',
  'monitor.updatedAt': '最后更新：{time}',
  // host form
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'monitor.selectHost': 'Select monitored host',
  'monitor.noHosts': 'Add an SSH host in the Hosts tab first.',
  'monitor.live': 'Live refresh',
  'monitor.interval': 'Every 3 seconds',
  'monitor.refreshing': 'Collecting…',
  'monitor.openTerminal': 'Open terminal',
  'monitor.unsupported': '{platform} monitoring is not supported yet; the live terminal remains available.',
  'monitor.cpu': 'CPU',
  'monitor.memory': 'Memory',
  'monitor.disk': 'System disk',
  'monitor.load': 'Load 1 / 5 / 15m',
  'monitor.uptime': 'Uptime',
  'monitor.processCount': 'Processes',
  'monitor.topProcesses': 'Top CPU processes',
  'monitor.command': 'Process',
  'monitor.terminate': 'Terminate',
  'monitor.killConfirm': 'Send TERM to PID {pid} ({command})? This affects the real remote service.',
  'monitor.failedServices': 'Failed systemd services',
  'monitor.servicesHealthy': 'No failed services detected.',
  'monitor.restart': 'Restart',
  'monitor.restartConfirm': 'Restart remote service "{service}" through sudo?',
  'monitor.actionDone': 'Remote operation completed.',
  'monitor.updatedAt': 'Last updated: {time}',
