...
test('desktop profile includes one plugin store plus Codex login and reasoning controls', () => {
  ...
  assert.equal(BUILTIN_BUNDLES.includes('@vectorize-io/hindsight-coding-agents'), true)
  ...
  assert.equal(MANAGED_RUNTIME_PACKAGES.includes('@vectorize-io/hindsight-coding-agents'), true)
